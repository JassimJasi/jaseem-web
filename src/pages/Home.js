  ...
  return (
    <Layout>
      <div>
        ...
        <div className='mt-20'>
          <h1 className='text-4xl text-blue-800 font-bold text-center my-6' data-aos='slide-right'>Technologies i Use</h1>
          <div className='grid md:grid-cols-1 grid-cols-3'>
            <FaReact size={170} color='cyan' className='w-full text-center mt-14' />
            <FaNodeJs size={170} color='green' className='w-full text-center mt-14 animate-bounce' />
            <FaBootstrap size={170} color='blue' className='w-full text-center mt-14' />
            <FaJsSquare size={170} color='green' className='w-full text-center mt-14 animate-bounce' />
            <FaHtml5 size={170} color='orange' className='w-full text-center mt-14' />
            <FaCss3 size={170} color='blue' className='w-full text-center mt-14 animate-bounce' />
          </div>
        </div>
        ...
        <div className='my-20'>
          ...
          <div className='md:mx-5 mx-32 shadow-2xl bg-gray-50 -mt-20 rounded-lg hover:bg-gray-700 '>
            <div className='h-80' data-aos="zoom-in" data-aos-duration="2500">
              <lottie-player src="https://assets1.lottiefiles.com/packages/lf20_kyu7xb1v.json"
                background="transparent"
                speed="1"
                loop
                autoplay></lottie-player>
            </div>
            <p className='text-xl my-5 font-semibold md:px-5 px-14 py-10 text-primary hover:text-white' data-aos="zoom-in" data-aos-duration="2500">
              React. js is an efficient, declarative,
              and flexible open-source JavaScript library that is useful for developing user
              interfaces specially for single page apps.</p>
          </div>
        </div>
        ...
        <div className='my-20'>
          ...
          <div className='md:mx-5 mx-32 shadow-2xl bg-gray-50 -mt-20 rounded-lg hover:bg-gray-700 ' data-aos="zoom-in" data-aos-duration="2500">
            <div className='h-80'>
              <lottie-player src="https://assets6.lottiefiles.com/packages/lf20_dlw10cqe.json"
                background="transparent"
                speed="1"
                loop
                autoplay></lottie-player>
            </div>
            <div className='grid md:grid-cols-1 grid-cols-3 text-green-500 hover:text-white p-10' data-aos="zoom-in" data-aos-duration="2500">
              ...
              <div className='text-right'>
                <h1 className='text-xl font-bold'>Back End, DB and Verion tools</h1>
                <hr />
        ...
        <div>
          <div>
            <h1 className='text-center text-4xl font-bold text-gray-600' data-aos='slide-up' >
              Who is Jaseem
            </h1>
          </div>
